package com.eureka.spartaonetoone.domain.address.application;
...
import com.eureka.spartaonetoone.domain.address.application.exception.AddressException;
import com.eureka.spartaonetoone.domain.address.domain.UserAddress;
import com.eureka.spartaonetoone.domain.address.domain.repository.UserAddressRepository;
...
public class UserAddressService {
    ...
    public List<UserAddressResponseDto> getAddressesByUser(UUID userId) {
        ...
        return addresses.stream()
                .map(UserAddressResponseDto::from) // 엔티티 -> DTO 변환
