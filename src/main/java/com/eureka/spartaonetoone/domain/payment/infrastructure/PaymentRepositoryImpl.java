package com.eureka.spartaonetoone.domain.payment.infrastructure;
...
import com.eureka.spartaonetoone.domain.payment.domain.repository.CustomPaymentRepository;
