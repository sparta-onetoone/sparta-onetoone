...
import com.eureka.spartaonetoone.common.utils.StringListConverter;
...
public class Store extends TimeStamp {
    ...
    private List<String> categoryIds; // uui1d,uuid2,uuid3
    ...
    private Store(UUID userId, String name, StoreState state, String tellNumber,
                  ...
                  Float rating, Integer reviewCount, List<String> categoryIds) {
        this.userId = userId;
        this.name = name;
        this.state = state;
